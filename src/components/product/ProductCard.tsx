      ...
      >
        ...
        <div className="relative aspect-[3/4] bg-gray-100 rounded-sm overflow-hidden">
          ...
          <img loading="lazy" decoding="async"
            src={product.images?.[currentImageIndex] || product.images?.[0] || 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600'}
            alt={name}
          ...
          <div className="absolute top-3 left-3 flex flex-col gap-1.5">
            ...
            {product.is_bestseller && (
              <span className="px-3 py-1 bg-[#B8956E] text-white text-xs font-medium rounded-full">
                {language === 'ar' ? 'الأكثر مبيعاً' : 'BEST'}
              </span>
            )}
            {product.stock_quantity === 0 && (
              <span className="px-3 py-1 bg-gray-800 text-white text-xs font-medium rounded-full">
                {language === 'ar' ? 'نفذ المخزون' : 'SOLD OUT'}
              </span>
            )}
          </div>
          ...
          {/* Quick Actions */}
          <div
            className={`absolute bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-black/80 to-transparent transform transition-transform duration-300 ${
          ...
          >
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 h-10 bg-white text-[#111111] rounded-md font-medium hover:bg-[#B8956E] hover:text-white transition-colors flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                className="h-10 w-10 bg-green-500 text-white rounded-md hover:bg-green-600 transition-colors flex items-center justify-center"
              >
        ...
        <div className="mt-4 space-y-1.5">
          ...
          {/* Name */}
          <h3 className="font-display font-medium text-ink group-hover:text-[#B8956E] transition-colors line-clamp-2">
            {name}
          </h3>
